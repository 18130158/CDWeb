...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th6 25, 2021 lúc 06:55 PM
...
(1, b'1', 'Bộ sách gồm 5 cuốn chứa các bài tập hỏi đáp bằng hình ảnh sinh động, đơn giản, ngắn gọn, dễ hiểu giúp rèn luyện trí thông minh và các hoạt động vui chơi kích thích trí não với các chủ đề dành cho trẻ 7 tuổi.', 0, b'0', b'0', 100, 120, 'NXB Kim đồng', 24, NULL, 'Lên Núi Cao Thử Tài Tinh Mắt', NULL, 1),
...
(42, b'1', 'Bộ sách vô cùng thú vị mang lại nhiều thông tin bổ ích về Thế giới động vật: Động vật thời Tiền sử, động vật hoang dã, sâu bọ, côn trùng... và cách thích nghi với môi trường của chúng.', 0, b'0', b'1', 105, 35, 'NXB Kim đồng', 9, NULL, 'Khủng Long Có Đẻ Trứng Không? - Hỏi Đáp Về Bò Sát Thời Tiền Sử', NULL, 1),
(43, b'1', 'Tuyển tập 150 bài văn mẫu hay giúp học sinh tham khảo nhằm nâng cao kỹ năng văn học.', 0, b'0', b'0', 70, 40, 'NXB Đà Nẵng', 15, NULL, '150 bài văn hay lớp 12', NULL, 2),
...
(19, b'1', 'Sách sinh học 7 sẽ mang đến cho các em chiếc chìa khóa khám phá thế giới tự nhiên đa dạng, đồng thời hiểu biết cơ bản về quá trình tiến hóa của động vật. ', 0, b'0', b'0', 22, 19, 'NXB Giao dục Việt Nam', 15, NULL, 'Sinh học lớp 7', NULL, 2),
...
(21, b'1', 'Vào lớp 1, các em học sinh được Tiếng Việt, học Toán và các môn học khác, trong đó có môn Nghệ thuật. Phần Âm nhạc trong môn Nghệ thuật lớp 1 dẽ dạy các em học 12 bài hát.', 33, b'0', b'0', 30, 14, 'NXB Giao dục Việt Nam', 15, NULL, 'Tập hát lớp 1', NULL, 2),
(20, b'1', 'Nội dung sách sẽ giúp các em làm quen với những ứng dụng của Công nghệ sinh học, hóa học, kinh tế họ trong các ngành sản xuất Nông - lâm - ngư nghiệp. Sách được biên soạn theo hướng đổi mới phương pháp đổi mới giáo dục, tích cực, chủ động, sáng tạo. Các bài học được trình bày theo cấu trúc: mục tiêu, cung cấp dữ liệu - thông tin về điều kiện, quy trình kỹ thuậ và gợi ý phương pháp xử lý thông tin.', 0, b'0', b'0', 35, 16, 'NXB Giao dục Việt Nam', 15, NULL, 'Công nghệ lớp 10', NULL, 2),
