...
public class AdminController {
    ...
    public String addProduct(@ModelAttribute("AddBookInput") AddBookInput bookInput) {
        ModelAndView mav = new ModelAndView("admin/product-add.html");
        mav.addObject("AddBookInput", new AddBookInput());
        mav.addObject("listcategory", categoryService.findAll());
    ...
    public String editProduct(@ModelAttribute("AddBookInput") AddBookInput bookInput) {
        ModelAndView mav = new ModelAndView("admin/product-add.html");
        mav.addObject("AddBookInput", new AddBookInput());
        mav.addObject("listcategory", categoryService.findAll());
        return "redirect:/admin";
    ...
    public ModelAndView editProductPage(@Param("id") long id) {
        ModelAndView mav = new ModelAndView("admin/product-add.html");
        mav.addObject("AddBookInput", new AddBookInput());
        mav.addObject("listcategory", categoryService.findAll());
    ...
    public ModelAndView addType(@ModelAttribute("category") CategoryDTO category) {
    ...
    public ModelAndView addUser(@ModelAttribute("userinput") UserInput userinput) {
    ...
    public ModelAndView editUserPage(@Param("email") String email) {
    ...
    public ModelAndView deleteUserPage(@Param("email") String email) {
    ...
    public ModelAndView editUser(@ModelAttribute("userinput") UserInput userinput) {
        UserDTO user = new UserDTO();
        List<RoleDTO> roleDTO = new ArrayList<>();
        for (String s : userinput.getRole()) {
            roleDTO.add(this.roleConverter.toDTO(this.roleRepository.findByName(s)));
